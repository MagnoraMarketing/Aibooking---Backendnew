    ...
    <div className="space-y-5 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <div>
        <h2 className="text-sm font-semibold uppercase tracking-wide text-slate-500">
          {t("adminPages.vapiVoiceTemplates.title")}
        </h2>
        <p className="mt-1 text-sm text-slate-500">{t("adminPages.vapiVoiceTemplates.description")}</p>
      </div>

      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          <label htmlFor="vapi-male-id" className="mb-1 block text-sm font-medium text-slate-700">
            {t("adminPages.vapiVoiceTemplates.maleFieldLabel")}
          </label>
          <input
            id="vapi-male-id"
            type="text"
        ...
        <div>
          <label htmlFor="vapi-female-id" className="mb-1 block text-sm font-medium text-slate-700">
            {t("adminPages.vapiVoiceTemplates.femaleFieldLabel")}
          </label>
          <input
            id="vapi-female-id"
            type="text"
