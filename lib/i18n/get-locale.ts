...
// NEXT_LOCALE cookie (the person's own choice, or Danish, which
// middleware.ts stamps on first visit), or the platform default if that
// hasn't run yet (e.g. middleware disabled in a preview environment).
