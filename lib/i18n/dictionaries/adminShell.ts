...
export const adminShell: Namespace = {
  ...
  "nav.inbound": { da: "Inbound (telefon-agenter)", en: "Inbound (phone agents)", es: "Entrante (agentes telefónicos)", fr: "Entrant (agents téléphoniques)", pt: "Entrada (agentes telefônicos)", de: "Inbound (Telefon-Agenten)" },
