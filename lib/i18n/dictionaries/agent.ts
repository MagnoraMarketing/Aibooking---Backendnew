...
export const agent: Namespace = {
  ...
  "webshop.description": {
    da: "Forbind jeres Shopify-webshop, så agenten kan svare på spørgsmål om produkter og slå kundernes ordrer op.",
    en: "Connect your Shopify webshop to let your AI agent answer product questions and track customer orders.",
    es: "Conecte su tienda Shopify para que el agente pueda responder preguntas sobre productos y consultar pedidos.",
    fr: "Connectez votre boutique Shopify pour que l'agent puisse répondre aux questions produits et suivre les commandes.",
    pt: "Ligue a sua loja Shopify para que o agente possa responder a perguntas sobre produtos e consultar encomendas.",
    de: "Verbinden Sie Ihren Shopify-Shop, damit der Agent Produktfragen beantworten und Bestellungen nachschlagen kann.",
  },
  "webshop.step1Title": {
    da: "1. Webshop",
    en: "1. Webshop",
  ...
  "webshop.step1Description": {
    da: "Indsæt adressen på jeres Shopify-webshop.",
    en: "Paste your Shopify webshop URL.",
    es: "Pegue la URL de su tienda Shopify.",
    fr: "Collez l'adresse de votre boutique Shopify.",
    pt: "Cole o endereço da sua loja Shopify.",
    de: "Fügen Sie die Adresse Ihres Shopify-Shops ein.",
  },
  ...
  "webshop.productsIndexed": {
    da: "{count} produkter indlæst",
    en: "{count} products indexed",
    es: "{count} productos indexados",
    fr: "{count} produits indexés",
    pt: "{count} produtos indexados",
    de: "{count} Produkte indexiert",
  },
  ...
  "webshop.step2Title": {
    da: "2. Ordresporing",
    en: "2. Order tracking",
    es: "2. Seguimiento de pedidos",
    fr: "2. Suivi des commandes",
    pt: "2. Rastreio de encomendas",
    de: "2. Bestellverfolgung",
  },
  "webshop.step2Description": {
    da: "Forbind jeres Shopify-konto, så AIbooking kan slå ordrestatus og tracking op.",
    en: "Connect your Shopify account to allow AIbooking to check order status and tracking.",
    es: "Conecte su cuenta de Shopify para que AIbooking pueda consultar el estado y el seguimiento de los pedidos.",
    fr: "Connectez votre compte Shopify pour qu'AIbooking puisse consulter le statut et le suivi des commandes.",
    pt: "Ligue a sua conta Shopify para que a AIbooking possa consultar o estado e o rastreio das encomendas.",
    de: "Verbinden Sie Ihr Shopify-Konto, damit AIbooking Bestellstatus und Sendungsverfolgung abfragen kann.",
  },
  ...
  "webshop.orderTrackingEnabled": {
    da: "Ordresporing aktiveret",
    en: "Order tracking enabled",
    es: "Seguimiento de pedidos activado",
    fr: "Suivi des commandes activé",
    pt: "Rastreio de encomendas ativado",
    de: "Bestellverfolgung aktiviert",
  },
  "webshop.storeLabel": {
    da: "Butik",
    en: "Store",
  ...
  "wizardWebshop.description": {
    da: "Har I en Shopify-webshop? Indsæt adressen, så kan agenten svare på spørgsmål om produkter, priser, størrelser og levering. Du kan springe over og gøre det senere.",
    en: "Do you have a Shopify webshop? Paste the URL and the agent can answer questions about products, prices, sizes and delivery. You can skip this and do it later.",
    es: "¿Tiene una tienda Shopify? Pegue la URL y el agente podrá responder preguntas sobre productos, precios, tallas y envíos. Puede omitirlo y hacerlo más tarde.",
    fr: "Vous avez une boutique Shopify ? Collez l'adresse et l'agent pourra répondre aux questions sur les produits, les prix, les tailles et la livraison. Vous pouvez passer et le faire plus tard.",
    pt: "Tem uma loja Shopify? Cole o endereço e o agente poderá responder a perguntas sobre produtos, preços, tamanhos e entrega. Pode ignorar e fazer isto mais tarde.",
    de: "Haben Sie einen Shopify-Shop? Fügen Sie die Adresse ein, damit der Agent Fragen zu Produkten, Preisen, Größen und Lieferung beantworten kann. Sie können das überspringen und später erledigen.",
  },
  "wizardWebshop.orderTrackingLater": {
    da: "Vil I også have ordresporing, sætter I det op under fanen Webshop bagefter.",
    en: "Want order tracking too? Set it up under the Webshop tab afterwards.",
    es: "¿También quiere seguimiento de pedidos? Configúrelo después en la pestaña Tienda online.",
    fr: "Vous voulez aussi le suivi des commandes ? Configurez-le ensuite dans l'onglet Boutique.",
    pt: "Também quer rastreio de encomendas? Configure-o depois no separador Loja online.",
    de: "Möchten Sie auch die Bestellverfolgung? Richten Sie sie danach im Tab Webshop ein.",
  },
  "wizardWebshop.skip": {
    da: "Spring over",
    en: "Skip",
