...
export const agent: Namespace = {
  ...
  "knowledgeBase.managedByShopify": {
    da: "Styres under Webshop",
    en: "Managed under Webshop",
    es: "Se gestiona en Tienda online",
    fr: "Géré dans Boutique",
    pt: "Gerido em Loja online",
    de: "Wird unter Webshop verwaltet",
  },
  ...
  "webshop.description": {
    da: "Forbind jeres Shopify-webshop, så agenten kan slå produkter, priser, størrelser, lager og ordrer op direkte i shoppen — altid med de aktuelle tal.",
    en: "Connect your Shopify webshop so your AI agent can look up products, prices, sizes, stock and orders straight from the shop — always current.",
    es: "Conecte su tienda Shopify para que el agente consulte productos, precios, tallas, stock y pedidos directamente en la tienda, siempre actualizados.",
    fr: "Connectez votre boutique Shopify pour que l'agent consulte produits, prix, tailles, stock et commandes directement dans la boutique, toujours à jour.",
    pt: "Ligue a sua loja Shopify para que o agente consulte produtos, preços, tamanhos, stock e encomendas diretamente na loja, sempre atualizados.",
    de: "Verbinden Sie Ihren Shopify-Shop, damit der Agent Produkte, Preise, Größen, Bestand und Bestellungen direkt im Shop nachschlägt — immer aktuell.",
  },
  "webshop.step1Title": {
    da: "1. Webshop",
    en: "1. Webshop",
  ...
  "webshop.step1Description": {
    da: "Indsæt adressen på jeres Shopify-webshop. Vi henter jeres sider om levering, retur og betingelser, så agenten kan svare på dem.",
    en: "Paste your Shopify webshop URL. We read your delivery, returns and terms pages so the agent can answer those questions.",
    es: "Pegue la URL de su tienda Shopify. Leemos sus páginas de envío, devoluciones y condiciones para que el agente pueda responderlas.",
    fr: "Collez l'adresse de votre boutique Shopify. Nous lisons vos pages livraison, retours et conditions pour que l'agent puisse y répondre.",
    pt: "Cole o endereço da sua loja Shopify. Lemos as suas páginas de entrega, devoluções e condições para o agente as poder responder.",
    de: "Fügen Sie die Adresse Ihres Shopify-Shops ein. Wir lesen Ihre Seiten zu Versand, Rückgabe und Bedingungen, damit der Agent sie beantworten kann.",
  },
  "webshop.urlPlaceholder": {
    da: "https://dinshop.dk",
    en: "https://yourshop.com",
    es: "https://tutienda.com",
    fr: "https://votreboutique.com",
    pt: "https://asualoja.com",
    de: "https://ihrshop.de",
  },
  "webshop.saveButton": {
    da: "Gem webshop",
    en: "Save webshop",
    es: "Guardar tienda",
    fr: "Enregistrer la boutique",
    pt: "Guardar loja",
    de: "Webshop speichern",
  },
  "webshop.saving": {
    da: "Henter webshoppen …",
    en: "Reading the webshop …",
    es: "Leyendo la tienda …",
    fr: "Lecture de la boutique …",
    pt: "A ler a loja …",
    de: "Webshop wird gelesen …",
  },
  "webshop.refreshButton": {
    da: "Opdatér Shopify-data",
    en: "Refresh Shopify data",
    es: "Actualizar datos de Shopify",
    fr: "Actualiser les données Shopify",
    pt: "Atualizar dados da Shopify",
    de: "Shopify-Daten aktualisieren",
  },
  "webshop.refreshing": {
    da: "Opdaterer …",
    en: "Refreshing …",
  ...
  "webshop.removeButton": {
    da: "Fjern webshop",
    en: "Remove webshop",
    es: "Quitar tienda",
    fr: "Retirer la boutique",
    pt: "Remover loja",
    de: "Webshop entfernen",
  },
  "webshop.removeConfirm": {
    da: "Fjern webshoppen fra denne agent? Agenten kan derefter ikke svare på produktspørgsmål eller slå ordrer op.",
    en: "Remove the webshop from this agent? It will no longer be able to answer product questions or look up orders.",
    es: "¿Quitar la tienda de este agente? Dejará de poder responder preguntas sobre productos o consultar pedidos.",
    fr: "Retirer la boutique de cet agent ? Il ne pourra plus répondre aux questions produits ni consulter les commandes.",
    pt: "Remover a loja deste agente? Deixará de poder responder a perguntas sobre produtos ou consultar encomendas.",
    de: "Webshop von diesem Agenten entfernen? Er kann dann keine Produktfragen mehr beantworten und keine Bestellungen nachschlagen.",
  },
  "webshop.statusConnected": {
    da: "Webshop forbundet",
    en: "Webshop connected",
    es: "Tienda conectada",
    fr: "Boutique connectée",
    pt: "Loja ligada",
    de: "Webshop verbunden",
  },
  ...
  "webshop.pagesIndexed": {
    da: "{count} sider indlæst",
    en: "{count} pages indexed",
    es: "{count} páginas indexadas",
    fr: "{count} pages indexées",
    pt: "{count} páginas indexadas",
    de: "{count} Seiten indexiert",
  },
  "webshop.lastSynced": {
    ...
    de: "Zuletzt synchronisiert: {date}",
  },
  "webshop.step2Title": {
    da: "2. Forbind Shopify",
    en: "2. Connect Shopify",
    es: "2. Conectar Shopify",
    fr: "2. Connecter Shopify",
    pt: "2. Ligar Shopify",
    de: "2. Shopify verbinden",
  },
  "webshop.step2Description": {
    da: "Forbind jeres Shopify-konto. Det er her agenten henter produkter, priser, størrelser, farver, lagerstatus, ordrestatus og tracking — live, hver gang en kunde spørger.",
    en: "Connect your Shopify account. This is where the agent looks up products, prices, sizes, colours, stock, order status and tracking — live, every time a customer asks.",
    es: "Conecte su cuenta de Shopify. Aquí el agente consulta productos, precios, tallas, colores, stock, estado del pedido y seguimiento, en vivo cada vez que un cliente pregunta.",
    fr: "Connectez votre compte Shopify. C'est là que l'agent consulte produits, prix, tailles, couleurs, stock, statut de commande et suivi — en direct, à chaque question.",
    pt: "Ligue a sua conta Shopify. É aqui que o agente consulta produtos, preços, tamanhos, cores, stock, estado da encomenda e rastreio — ao vivo, sempre que um cliente pergunta.",
    de: "Verbinden Sie Ihr Shopify-Konto. Hier schlägt der Agent Produkte, Preise, Größen, Farben, Bestand, Bestellstatus und Sendungsverfolgung nach — live bei jeder Frage.",
  },
  ...
  "webshop.orderTrackingEnabled": {
    da: "Produkter og ordrer forbundet",
    en: "Products and orders connected",
    es: "Productos y pedidos conectados",
    fr: "Produits et commandes connectés",
    pt: "Produtos e encomendas ligados",
    de: "Produkte und Bestellungen verbunden",
  },
  "webshop.storeLabel": {
    da: "Butik",
    en: "Store",
  ...
  "webshop.disconnectOrderTracking": {
    da: "Afbryd ordresporing",
    en: "Disconnect order tracking",
    es: "Desconectar seguimiento",
    fr: "Déconnecter le suivi",
    pt: "Desligar rastreio",
    de: "Bestellverfolgung trennen",
  },
  ...
  "webshop.shopDomainHelp": {
    da: "Den adresse I logger ind på i Shopify — den slutter altid på .myshopify.com.",
    en: "The address you log in to Shopify with — it always ends in .myshopify.com.",
    es: "La dirección con la que inicia sesión en Shopify: siempre termina en .myshopify.com.",
    fr: "L'adresse avec laquelle vous vous connectez à Shopify — elle se termine toujours par .myshopify.com.",
    pt: "O endereço com que inicia sessão na Shopify — termina sempre em .myshopify.com.",
    de: "Die Adresse, mit der Sie sich bei Shopify anmelden — sie endet immer auf .myshopify.com.",
  },
  "webshop.saveWebshopFirst": {
    da: "Gem jeres webshop-adresse først.",
    en: "Save your webshop URL first.",
    es: "Guarde primero la URL de su tienda.",
    fr: "Enregistrez d'abord l'adresse de votre boutique.",
    pt: "Guarde primeiro o endereço da sua loja.",
    de: "Speichern Sie zuerst Ihre Webshop-Adresse.",
  },
  ...
  "webshop.errorInvalidUrl": {
    da: "Indtast en gyldig adresse på jeres Shopify-webshop.",
    en: "Please enter a valid Shopify webshop URL.",
    es: "Introduzca una URL válida de su tienda Shopify.",
    fr: "Saisissez une adresse de boutique Shopify valide.",
    pt: "Introduza um endereço válido da sua loja Shopify.",
    de: "Bitte geben Sie eine gültige Shopify-Webshop-Adresse ein.",
  },
  "webshop.errorCrawlFailed": {
    da: "Vi kunne ikke læse denne webshop. Tjek adressen.",
    en: "We couldn't read this webshop. Please check the URL.",
    es: "No pudimos leer esta tienda. Compruebe la URL.",
    fr: "Nous n'avons pas pu lire cette boutique. Vérifiez l'adresse.",
    pt: "Não conseguimos ler esta loja. Verifique o endereço.",
    de: "Wir konnten diesen Webshop nicht lesen. Bitte prüfen Sie die Adresse.",
  },
  "webshop.errorNotShopify": {
    da: "Adressen ser ikke ud til at være en Shopify-webshop. Tjek adressen.",
    en: "That address doesn't look like a Shopify webshop. Please check the URL.",
    es: "Esa dirección no parece una tienda Shopify. Compruebe la URL.",
    fr: "Cette adresse ne semble pas être une boutique Shopify. Vérifiez l'adresse.",
    pt: "Esse endereço não parece ser uma loja Shopify. Verifique o endereço.",
    de: "Diese Adresse scheint kein Shopify-Webshop zu sein. Bitte prüfen Sie die Adresse.",
  },
  ...
  // agent-tabs/wizard-webshop-step.tsx
  "wizard.step.webshop": {
    da: "Webshop",
    en: "Webshop",
    es: "Tienda online",
  ...
  "wizardWebshop.description": {
    da: "Har I en Shopify-webshop? Indsæt adressen, så kan agenten svare på levering, retur og betingelser. Du kan springe over og gøre det senere.",
    en: "Do you have a Shopify webshop? Paste the URL so the agent can answer delivery, returns and terms questions. You can skip this and do it later.",
    es: "¿Tiene una tienda Shopify? Pegue la URL para que el agente pueda responder sobre envíos, devoluciones y condiciones. Puede omitirlo y hacerlo más tarde.",
    fr: "Vous avez une boutique Shopify ? Collez l'adresse pour que l'agent puisse répondre sur la livraison, les retours et les conditions. Vous pouvez passer et le faire plus tard.",
    pt: "Tem uma loja Shopify? Cole o endereço para o agente poder responder sobre entrega, devoluções e condições. Pode ignorar e fazer isto mais tarde.",
    de: "Haben Sie einen Shopify-Shop? Fügen Sie die Adresse ein, damit der Agent Versand, Rückgabe und Bedingungen beantworten kann. Sie können das überspringen und später erledigen.",
  },
  "wizardWebshop.orderTrackingLater": {
    da: "Skal agenten også kunne svare på produkter, priser, lager og ordrer, forbinder I Shopify under fanen Webshop bagefter.",
    en: "For product, price, stock and order questions, connect Shopify under the Webshop tab afterwards.",
    es: "Para preguntas de productos, precios, stock y pedidos, conecte Shopify después en la pestaña Tienda online.",
    fr: "Pour les questions produits, prix, stock et commandes, connectez Shopify ensuite dans l'onglet Boutique.",
    pt: "Para perguntas sobre produtos, preços, stock e encomendas, ligue a Shopify depois no separador Loja online.",
    de: "Für Fragen zu Produkten, Preisen, Bestand und Bestellungen verbinden Sie Shopify danach im Tab Webshop.",
  },
  "wizardWebshop.skip": {
    da: "Spring over",
    en: "Skip",
