...
export const agent: Namespace = {
  ...
  "webshop.tokenStep1": {
    da: "1. Gå til Shopify → Settings → Apps and sales channels → Develop apps → Create an app.",
    en: "1. Go to Shopify → Settings → Apps and sales channels → Develop apps → Create an app.",
    es: "1. Vaya a Shopify → Settings → Apps and sales channels → Develop apps → Create an app.",
    fr: "1. Allez dans Shopify → Settings → Apps and sales channels → Develop apps → Create an app.",
    pt: "1. Vá a Shopify → Settings → Apps and sales channels → Develop apps → Create an app.",
    de: "1. Gehen Sie zu Shopify → Settings → Apps and sales channels → Develop apps → Create an app.",
  },
  "webshop.tokenStep2": {
