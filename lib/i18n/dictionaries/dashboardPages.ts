...
export const dashboardPages: Namespace = {
  ...
  "inbound.paywallTitle": {
    da: "Få jeres eget nummer med en pakke",
    en: "Get your own number with a package",
    es: "Obtenga su propio número con un paquete",
    fr: "Obtenez votre propre numéro avec un forfait",
    pt: "Obtenha o seu próprio número com um pacote",
    de: "Holen Sie sich Ihre eigene Nummer mit einem Paket",
  },
  "inbound.paywallSubtitle": {
    da: "I kan altid bygge og afprøve agenten gratis — men et rigtigt nummer, I kan viderestille til, kræver en betalt pakke.",
    en: "You can always build and try the agent for free — but a real number to forward to requires a paid package.",
    es: "Siempre puede crear y probar el agente de forma gratuita — pero un número real al que desviar requiere un paquete de pago.",
    fr: "Vous pouvez toujours créer et essayer l'agent gratuitement — mais un vrai numéro vers lequel transférer nécessite un forfait payant.",
    pt: "Pode sempre criar e experimentar o agente gratuitamente — mas um número real para o qual encaminhar requer um pacote pago.",
    de: "Sie können den Agenten jederzeit kostenlos einrichten und testen — aber eine echte Nummer zum Weiterleiten erfordert ein bezahltes Paket.",
  },
  "inbound.paywallCta": {
    da: "Se pakker →",
    en: "See packages →",
