...
export const dashboardPages: Namespace = {
  ...
  "billing.paymentFailedMessage": {
    da: "Jeres minutpulje er opbrugt, og den automatiske betaling kunne ikke gennemføres. Voice-adgang er låst, indtil betalingen lykkes.",
    en: "Your minute pool is exhausted and the automatic payment could not go through. Voice access is locked until payment succeeds.",
    es: "Su bolsa de minutos se agotó y el pago automático no pudo procesarse. El acceso de voz está bloqueado hasta que el pago se realice correctamente.",
    fr: "Votre pool de minutes est épuisé et le paiement automatique n'a pas pu aboutir. L'accès vocal est verrouillé jusqu'à ce que le paiement réussisse.",
    pt: "Seu pool de minutos se esgotou e o pagamento automático não pôde ser concluído. O acesso de voz está bloqueado até que o pagamento seja bem-sucedido.",
    de: "Ihr Minutenpool ist aufgebraucht, und die automatische Zahlung konnte nicht durchgeführt werden. Der Sprachzugriff ist gesperrt, bis die Zahlung erfolgreich ist.",
  },
  "billing.updateCard": {
    da: "Opdater betalingskort",
    en: "Update payment card",
    es: "Actualizar tarjeta de pago",
    fr: "Mettre à jour la carte de paiement",
    pt: "Atualizar cartão de pagamento",
    de: "Zahlungskarte aktualisieren",
  },
  "billing.minutesUsedOfIncluded": {
    da: "{used} af {included} minutter brugt",
    en: "{used} of {included} minutes used",
    es: "{used} de {included} minutos usados",
    fr: "{used} minutes utilisées sur {included}",
    pt: "{used} de {included} minutos usados",
    de: "{used} von {included} Minuten verbraucht",
  },
  "billing.autoRechargeNote": {
    da: "Jeres pakke fornyes automatisk med {minutes} nye minutter for {price}, når de nuværende minutter er brugt.",
    en: "Your plan automatically renews with {minutes} fresh minutes for {price} once the current minutes run out.",
    es: "Su plan se renueva automáticamente con {minutes} minutos nuevos por {price} cuando se agoten los minutos actuales.",
    fr: "Votre forfait se renouvelle automatiquement avec {minutes} nouvelles minutes pour {price} une fois les minutes actuelles épuisées.",
    pt: "Seu plano é renovado automaticamente com {minutes} novos minutos por {price} quando os minutos atuais acabarem.",
    de: "Ihr Tarif wird automatisch mit {minutes} neuen Minuten für {price} verlängert, sobald die aktuellen Minuten aufgebraucht sind.",
  },
  "billing.includeSetupLabel": {
    da: "Tilkøb opsætning og onboarding ved bestilling",
    en: "Add setup and onboarding to this order",
    es: "Añadir configuración e incorporación a este pedido",
    fr: "Ajouter la configuration et l'intégration à cette commande",
    pt: "Adicionar configuração e integração a este pedido",
    de: "Einrichtung und Onboarding zu dieser Bestellung hinzufügen",
  },
  "billing.switchToPackage": {
    da: "Skift til denne pakke →",
    en: "Switch to this plan →",
    es: "Cambiar a este plan →",
    fr: "Passer à ce forfait →",
    pt: "Mudar para este plano →",
    de: "Zu diesem Tarif wechseln →",
  },
  "billing.paymentHistoryHeading": {
    da: "Betalingshistorik",
    en: "Payment history",
  ...
  "inbound.vapiIntro": {
    da: "Agenten får sit eget nummer med det samme. Viderestil jeres nuværende nummer til det, så svarer agenten — I beholder det nummer, jeres kunder kender.",
    en: "The agent gets its own number right away. Forward your current number to it and the agent answers — you keep the number your customers know.",
    es: "El agente recibe su propio número de inmediato. Desvíe su número actual a él y el agente responderá: usted conserva el número que sus clientes conocen.",
    fr: "L'agent reçoit immédiatement son propre numéro. Transférez-y votre numéro actuel et l'agent répond — vous gardez le numéro que vos clients connaissent.",
    pt: "O agente recebe o seu próprio número de imediato. Encaminhe o seu número atual para ele e o agente atende — mantém o número que os seus clientes conhecem.",
    de: "Der Agent erhält sofort eine eigene Nummer. Leiten Sie Ihre aktuelle Nummer dorthin um, und der Agent geht ran — Sie behalten die Nummer, die Ihre Kunden kennen.",
  },
  "inbound.areaCodeLabel": {
    da: "Områdenummer (valgfrit)",
    en: "Area code (optional)",
    es: "Código de área (opcional)",
    fr: "Indicatif régional (facultatif)",
    pt: "Indicativo (opcional)",
    de: "Vorwahl (optional)",
  },
  ...
  "inbound.spareNumbersTitle": {
    da: "Numre I allerede har — vælg ét, så kobles det på agenten med det samme",
    en: "Numbers you already have — pick one and it's attached to the agent right away",
    es: "Números que ya tiene: elija uno y se asignará al agente de inmediato",
    fr: "Numéros que vous avez déjà — choisissez-en un et il est rattaché à l'agent aussitôt",
    pt: "Números que já tem — escolha um e é ligado ao agente de imediato",
    de: "Nummern, die Sie bereits haben — wählen Sie eine, und sie wird sofort dem Agenten zugeordnet",
  },
  "inbound.spareNumbersClear": {
    da: "Fravælg — hent et nyt nummer i stedet",
    en: "Deselect — get a new number instead",
    es: "Deseleccionar: obtener un número nuevo",
    fr: "Désélectionner — obtenir un nouveau numéro",
    pt: "Desmarcar — obter um número novo",
    de: "Abwählen — stattdessen eine neue Nummer holen",
  },
  "inbound.useNumber": {
    da: "Brug nummeret",
    en: "Use this number",
  ...
  "inbound.gettingNumber": {
    da: "Henter nummer…",
    en: "Getting number…",
    es: "Obteniendo número…",
    fr: "Obtention du numéro…",
    pt: "A obter número…",
    de: "Nummer wird geholt…",
  },
  "inbound.errorGetNumber": {
    da: "Nummeret kunne ikke hentes. Prøv igen.",
    en: "The number couldn't be fetched. Please try again.",
    es: "No se pudo obtener el número. Inténtelo de nuevo.",
    fr: "Le numéro n'a pas pu être obtenu. Réessayez.",
    pt: "Não foi possível obter o número. Tente novamente.",
    de: "Die Nummer konnte nicht geholt werden. Bitte erneut versuchen.",
  },
  "inbound.newNumber": {
    da: "+ Nyt nummer",
    en: "+ New number",
  ...
  "outbound.agentInstructionLabel": {
    da: "Hvad skal agenten sige om formålet? (valgfrit)",
    en: "What should the agent say the call is about? (optional)",
    es: "¿Qué debe decir el agente sobre el motivo? (opcional)",
    fr: "Que doit dire l'agent sur l'objet de l'appel ? (facultatif)",
    pt: "O que deve o agente dizer sobre o motivo? (opcional)",
    de: "Was soll der Agent zum Anlass sagen? (optional)",
  },
  "outbound.agentInstructionPlaceholder": {
    da: "Fx: Ring og mind kunden om tiden i morgen, og spørg om den passer.",
    en: "E.g. Call to remind the customer about tomorrow's appointment and check it still suits them.",
    es: "P. ej.: Llama para recordar la cita de mañana y confirmar que le viene bien.",
    fr: "Ex. : Appelez pour rappeler le rendez-vous de demain et vérifier qu'il convient toujours.",
    pt: "Ex.: Ligue para lembrar a marcação de amanhã e confirmar se ainda dá jeito.",
    de: "Z. B.: Rufen Sie an, um an den Termin morgen zu erinnern und zu fragen, ob er noch passt.",
  },
  "outbound.agentInstructionHelp": {
    da: "Lægges oven på agentens egen prompt — kun for denne kampagnes opkald. Agenten der tager telefonen ændres ikke.",
    en: "Added on top of the agent's own prompt, for this campaign's calls only. The agent that answers the phone is unchanged.",
    es: "Se añade al prompt del agente, solo para las llamadas de esta campaña. El agente que contesta no cambia.",
    fr: "Ajouté au prompt de l'agent, uniquement pour les appels de cette campagne. L'agent qui répond reste inchangé.",
    pt: "Adicionado ao prompt do agente, apenas para as chamadas desta campanha. O agente que atende fica inalterado.",
    de: "Wird dem Prompt des Agenten hinzugefügt, nur für die Anrufe dieser Kampagne. Der Agent am Telefon bleibt unverändert.",
  },
  "outbound.callDaysLabel": {
    da: "Ringedage",
    en: "Calling days",
    es: "Días de llamada",
    fr: "Jours d'appel",
  ...
  "outbound.concurrencyLabel": {
    da: "Samtidige opkald",
    en: "Calls at a time",
    es: "Llamadas a la vez",
    fr: "Appels simultanés",
    pt: "Chamadas em simultâneo",
    de: "Gleichzeitige Anrufe",
  },
  "outbound.maxAttemptsLabel": {
    da: "Forsøg pr. kontakt",
    en: "Attempts per contact",
    es: "Intentos por contacto",
    fr: "Tentatives par contact",
    pt: "Tentativas por contacto",
    de: "Versuche pro Kontakt",
  },
  "outbound.retryAfterLabel": {
    da: "Minutter mellem forsøg",
    en: "Minutes between attempts",
    es: "Minutos entre intentos",
    fr: "Minutes entre les tentatives",
    pt: "Minutos entre tentativas",
    de: "Minuten zwischen Versuchen",
  },
  "outbound.saveCampaign": {
    da: "Gem ændringer",
    en: "Save changes",
    es: "Guardar cambios",
  ...
  "outbound.errorNoCallDays": {
    da: "Vælg mindst én dag, der må ringes på.",
    en: "Pick at least one day calls may go out on.",
    es: "Elige al menos un día en el que se pueda llamar.",
    fr: "Choisissez au moins un jour où les appels peuvent partir.",
    pt: "Escolha pelo menos um dia em que se pode ligar.",
    de: "Wählen Sie mindestens einen Tag, an dem angerufen werden darf.",
  },
  "outbound.errorWindowOrder": {
    da: "Ringetiderne skal starte før de slutter.",
    en: "The calling hours have to start before they end.",
    es: "El horario de llamadas debe empezar antes de terminar.",
    fr: "Les heures d'appel doivent commencer avant de se terminer.",
    pt: "O horário de chamadas tem de começar antes de terminar.",
    de: "Die Anrufzeiten müssen vor ihrem Ende beginnen.",
  },
  "outbound.errorLoadCampaign": {
    da: "Kunne ikke hente kampagnens kontakter.",
    en: "Could not load the campaign's contacts.",
    es: "No se pudieron cargar los contactos de la campaña.",
    fr: "Impossible de charger les contacts de la campagne.",
    pt: "Não foi possível carregar os contactos da campanha.",
    de: "Die Kontakte der Kampagne konnten nicht geladen werden.",
  },
  "outbound.errorDelete": {
    da: "Kampagnen kunne ikke slettes.",
    en: "The campaign could not be deleted.",
    es: "No se pudo eliminar la campaña.",
    fr: "La campagne n'a pas pu être supprimée.",
    pt: "Não foi possível eliminar a campanha.",
    de: "Die Kampagne konnte nicht gelöscht werden.",
  },
  "outbound.queuedNow": {
    da: "{count} opkald er sat i kø, og de første er på vej ud nu.",
    en: "{count} calls queued, and the first are going out now.",
    es: "{count} llamadas en cola; las primeras salen ahora.",
    fr: "{count} appels en file d'attente ; les premiers partent maintenant.",
    pt: "{count} chamadas em fila; as primeiras estão a sair agora.",
    de: "{count} Anrufe in der Warteschlange, die ersten gehen jetzt raus.",
  },
  "outbound.queuedLater": {
    da: "{count} opkald er sat i kø. Der ringes først {time}, fordi det er uden for kampagnens ringetider.",
    en: "{count} calls queued. The first goes out {time}, because now is outside the campaign's calling hours.",
    es: "{count} llamadas en cola. La primera saldrá {time}, porque ahora está fuera del horario de llamadas.",
    fr: "{count} appels en file d'attente. Le premier partira {time}, car nous sommes hors des heures d'appel.",
    pt: "{count} chamadas em fila. A primeira sai {time}, porque agora está fora do horário de chamadas.",
    de: "{count} Anrufe in der Warteschlange. Der erste geht {time} raus, weil es jetzt außerhalb der Anrufzeiten liegt.",
  },
  "outbound.weekday.mon": { da: "Man", en: "Mon", es: "Lun", fr: "Lun", pt: "Seg", de: "Mo" },
  "outbound.weekday.tue": { da: "Tir", en: "Tue", es: "Mar", fr: "Mar", pt: "Ter", de: "Di" },
  "outbound.weekday.wed": { da: "Ons", en: "Wed", es: "Mié", fr: "Mer", pt: "Qua", de: "Mi" },
  "outbound.weekday.thu": { da: "Tor", en: "Thu", es: "Jue", fr: "Jeu", pt: "Qui", de: "Do" },
  "outbound.weekday.fri": { da: "Fre", en: "Fri", es: "Vie", fr: "Ven", pt: "Sex", de: "Fr" },
  "outbound.weekday.sat": { da: "Lør", en: "Sat", es: "Sáb", fr: "Sam", pt: "Sáb", de: "Sa" },
  "outbound.weekday.sun": { da: "Søn", en: "Sun", es: "Dom", fr: "Dim", pt: "Dom", de: "So" },
  ...
  // The campaign overview and the contact list behind it — the same columns
  // Inbound shows for calls, per campaign and then per person.
  "outbound.errorChooseLeadList": { da: "Vælg en ringeliste.", en: "Choose a lead list.", es: "Elija una lista de contactos.", fr: "Choisissez une liste de contacts.", pt: "Escolha uma lista de contactos.", de: "Wählen Sie eine Kontaktliste." },
  "outbound.sourcePaste": { da: "Indsæt kontakter", en: "Paste contacts", es: "Pegar contactos", fr: "Coller des contacts", pt: "Colar contactos", de: "Kontakte einfügen" },
  "outbound.sourceLeadList": { da: "Brug en ringeliste", en: "Use a lead list", es: "Usar una lista de contactos", fr: "Utiliser une liste de contacts", pt: "Usar uma lista de contactos", de: "Kontaktliste verwenden" },
  "outbound.leadListLabel": { da: "Ringeliste", en: "Lead list", es: "Lista de contactos", fr: "Liste de contacts", pt: "Lista de contactos", de: "Kontaktliste" },
  "outbound.leadListHelp": { da: "Kontakterne hentes fra listen (upload CSV under Dialer). Numre på spærrelisten springes over.", en: "Contacts are taken from the list (upload a CSV under Dialer). Numbers on the do-not-call list are skipped.", es: "Los contactos se toman de la lista (suba un CSV en Dialer). Se omiten los números de la lista de exclusión.", fr: "Les contacts sont repris de la liste (importez un CSV dans Dialer). Les numéros de la liste d'exclusion sont ignorés.", pt: "Os contactos vêm da lista (carregue um CSV em Dialer). Números na lista de exclusão são ignorados.", de: "Die Kontakte stammen aus der Liste (CSV unter Dialer hochladen). Nummern auf der Sperrliste werden übersprungen." },
  "outbound.variablesHelp": { da: "Agenten kan bruge leadets felter i sin prompt, fx {{name}}, {{company}} og alle ekstra kolonner fra CSV-filen som {{city}}.", en: "The agent can use the lead's fields in its prompt, e.g. {{name}}, {{company}} and every extra CSV column such as {{city}}.", es: "El agente puede usar los campos del contacto en su prompt, p. ej. {{name}}, {{company}} y cualquier columna extra del CSV como {{city}}.", fr: "L'agent peut utiliser les champs du contact dans son prompt, p. ex. {{name}}, {{company}} et toute colonne CSV supplémentaire comme {{city}}.", pt: "O agente pode usar os campos do contacto no prompt, p. ex. {{name}}, {{company}} e qualquer coluna extra do CSV como {{city}}.", de: "Der Agent kann die Felder des Kontakts im Prompt nutzen, z. B. {{name}}, {{company}} und jede zusätzliche CSV-Spalte wie {{city}}." },
  "outbound.voicemailLabel": { da: "Besked på telefonsvarer (valgfri)", en: "Voicemail message (optional)", es: "Mensaje de buzón de voz (opcional)", fr: "Message sur répondeur (facultatif)", pt: "Mensagem de correio de voz (opcional)", de: "Nachricht auf Anrufbeantworter (optional)" },
  "outbound.voicemailPlaceholder": { da: "Hej, det er AIbooking. Vi ringer igen senere.", en: "Hi, this is AIbooking. We'll call again later.", es: "Hola, somos AIbooking. Volveremos a llamar.", fr: "Bonjour, c'est AIbooking. Nous rappellerons plus tard.", pt: "Olá, é a AIbooking. Voltaremos a ligar.", de: "Hallo, hier ist AIbooking. Wir rufen später wieder an." },
  "outbound.voicemailHelp": { da: "Siges, hvis opkaldet ender på en telefonsvarer. Tom = agentens egen opførsel. Kontakten prøves igen efter reglerne for gentagne forsøg.", en: "Spoken if the call reaches voicemail. Empty = the agent's own behaviour. The contact is retried per the retry settings.", es: "Se dice si la llamada llega al buzón. Vacío = comportamiento propio del agente. Se reintenta según la configuración.", fr: "Prononcé si l'appel tombe sur un répondeur. Vide = comportement de l'agent. Le contact est rappelé selon les réglages.", pt: "Dito se a chamada cair no correio de voz. Vazio = comportamento do agente. O contacto é repetido conforme as definições.", de: "Wird gesprochen, wenn der Anruf auf dem Anrufbeantworter landet. Leer = Verhalten des Agenten. Der Kontakt wird gemäß den Einstellungen erneut angerufen." },
  "outbound.testOneLead": { da: "Test med ét lead", en: "Test with one lead", es: "Probar con un contacto", fr: "Tester avec un contact", pt: "Testar com um contacto", de: "Mit einem Kontakt testen" },
  "outbound.testCallStarted": { da: "Testopkald startet til {number}.", en: "Test call started to {number}.", es: "Llamada de prueba iniciada a {number}.", fr: "Appel test lancé vers {number}.", pt: "Chamada de teste iniciada para {number}.", de: "Testanruf an {number} gestartet." },
  "outbound.stopCampaign": { da: "Stop kampagne", en: "Stop campaign", es: "Detener campaña", fr: "Arrêter la campagne", pt: "Parar campanha", de: "Kampagne stoppen" },
  "outbound.stopConfirm": { da: "Stop kampagnen for good? Kontakter, der ikke er ringet op endnu, bliver ikke ringet op.", en: "Stop the campaign for good? Contacts not called yet will not be called.", es: "¿Detener la campaña definitivamente? Los contactos pendientes no se llamarán.", fr: "Arrêter définitivement la campagne ? Les contacts restants ne seront pas appelés.", pt: "Parar a campanha de vez? Os contactos por ligar não serão contactados.", de: "Kampagne endgültig stoppen? Noch nicht angerufene Kontakte werden nicht angerufen." },
  "outbound.stoppedNotice": { da: "Kampagnen er stoppet.", en: "The campaign has been stopped.", es: "La campaña se ha detenido.", fr: "La campagne a été arrêtée.", pt: "A campanha foi parada.", de: "Die Kampagne wurde gestoppt." },
  "outbound.liveActivity": { da: "Live aktivitet", en: "Live activity", es: "Actividad en vivo", fr: "Activité en direct", pt: "Atividade ao vivo", de: "Live-Aktivität" },
  "outbound.outcome.calling": { da: "Ringer nu", en: "Calling", es: "Llamando", fr: "En appel", pt: "A ligar", de: "Ruft an" },
  "outbound.outcome.answered": { da: "Besvaret", en: "Answered", es: "Contestada", fr: "Répondu", pt: "Atendida", de: "Angenommen" },
  "outbound.outcome.no_answer": { da: "Ingen svar", en: "No answer", es: "Sin respuesta", fr: "Pas de réponse", pt: "Sem resposta", de: "Keine Antwort" },
  "outbound.outcome.busy": { da: "Optaget", en: "Busy", es: "Ocupado", fr: "Occupé", pt: "Ocupado", de: "Besetzt" },
  "outbound.outcome.voicemail": { da: "Telefonsvarer", en: "Voicemail", es: "Buzón de voz", fr: "Répondeur", pt: "Correio de voz", de: "Mailbox" },
  "outbound.outcome.failed": { da: "Fejlede", en: "Failed", es: "Fallida", fr: "Échoué", pt: "Falhou", de: "Fehlgeschlagen" },
  "outbound.outcome.interested": { da: "Interesseret", en: "Interested", es: "Interesado", fr: "Intéressé", pt: "Interessado", de: "Interessiert" },
  "outbound.outcome.meeting_booked": { da: "Møde booket", en: "Meeting booked", es: "Reunión reservada", fr: "RDV réservé", pt: "Reunião marcada", de: "Termin gebucht" },
  "outbound.outcome.callback": { da: "Tilbagekald", en: "Callback", es: "Devolver llamada", fr: "Rappel", pt: "Ligar de volta", de: "Rückruf" },
  "outbound.outcome.not_interested": { da: "Ikke interesseret", en: "Not interested", es: "No interesado", fr: "Pas intéressé", pt: "Não interessado", de: "Kein Interesse" },
  "outbound.outcome.wrong_number": { da: "Forkert nummer", en: "Wrong number", es: "Número equivocado", fr: "Mauvais numéro", pt: "Número errado", de: "Falsche Nummer" },
  "outbound.outcome.do_not_call": { da: "Må ikke ringes op", en: "Do not call", es: "No llamar", fr: "Ne pas appeler", pt: "Não ligar", de: "Nicht anrufen" },
  "outbound.outcome.other": { da: "Andet", en: "Other", es: "Otro", fr: "Autre", pt: "Outro", de: "Sonstiges" },
  "outbound.duplicateCampaign": { da: "Dupliker", en: "Duplicate", es: "Duplicar", fr: "Dupliquer", pt: "Duplicar", de: "Duplizieren" },
  "outbound.duplicatedNotice": { da: "Kampagnen er kopieret som en ny kladde med de samme kontakter.", en: "The campaign was copied as a new draft with the same contacts.", es: "La campaña se copió como un nuevo borrador con los mismos contactos.", fr: "La campagne a été copiée en nouveau brouillon avec les mêmes contacts.", pt: "A campanha foi copiada como novo rascunho com os mesmos contactos.", de: "Die Kampagne wurde als neuer Entwurf mit denselben Kontakten kopiert." },
  "outbound.retryRulesLabel": { da: "Ring igen efter (minutter)", en: "Retry after (minutes)", es: "Reintentar tras (minutos)", fr: "Rappeler après (minutes)", pt: "Repetir após (minutos)", de: "Erneut anrufen nach (Minuten)" },
  "outbound.retryRulesHelp": { da: "Fx ingen svar efter 4 timer (240), optaget efter 30 min, telefonsvarer næste dag (1440). Besvarede opkald, forkerte numre og 'må ikke ringes op' prøves aldrig igen.", en: "E.g. no answer after 4 hours (240), busy after 30 min, voicemail next day (1440). Answered calls, wrong numbers and do-not-call are never retried.", es: "P. ej. sin respuesta tras 4 horas (240), ocupado tras 30 min, buzón al día siguiente (1440). Las contestadas, números erróneos y 'no llamar' nunca se reintentan.", fr: "P. ex. pas de réponse après 4 h (240), occupé après 30 min, répondeur le lendemain (1440). Les appels répondus, mauvais numéros et 'ne pas appeler' ne sont jamais relancés.", pt: "P. ex. sem resposta após 4 h (240), ocupado após 30 min, correio de voz no dia seguinte (1440). Atendidas, números errados e 'não ligar' nunca se repetem.", de: "Z. B. keine Antwort nach 4 Std. (240), besetzt nach 30 Min., Mailbox am nächsten Tag (1440). Angenommene Anrufe, falsche Nummern und 'nicht anrufen' werden nie wiederholt." },
  "outbound.colAnswered": { da: "Besvaret", en: "Answered", es: "Contestadas", fr: "Répondus", pt: "Atendidas", de: "Angenommen" },
  "outbound.colMeetings": { da: "Møder", en: "Meetings", es: "Reuniones", fr: "RDV", pt: "Reuniões", de: "Termine" },
  "outbound.status.draft": { da: "Kladde", en: "Draft", es: "Borrador", fr: "Brouillon", pt: "Rascunho", de: "Entwurf" },
  "outbound.status.running": { da: "Kører", en: "Running", es: "En curso", fr: "En cours", pt: "Em execução", de: "Läuft" },
  "outbound.status.paused": { da: "På pause", en: "Paused", es: "En pausa", fr: "En pause", pt: "Em pausa", de: "Pausiert" },
  ...
  "outbound.status.cancelled": { da: "Stoppet", en: "Stopped", es: "Detenida", fr: "Arrêtée", pt: "Parada", de: "Gestoppt" },
  "outbound.status.failed": { da: "Fejlet", en: "Failed", es: "Fallida", fr: "Échouée", pt: "Falhou", de: "Fehlgeschlagen" },
  "outbound.colCampaign": { da: "Kampagne", en: "Campaign", es: "Campaña", fr: "Campagne", pt: "Campanha", de: "Kampagne" },
  "outbound.colStatus": { da: "Status", en: "Status", es: "Estado", fr: "Statut", pt: "Estado", de: "Status" },
  "outbound.colTotal": { da: "Kontakter", en: "Contacts", es: "Contactos", fr: "Contacts", pt: "Contatos", de: "Kontakte" },
  "outbound.colCalled": { da: "Ringet op", en: "Called", es: "Llamados", fr: "Appelés", pt: "Chamados", de: "Angerufen" },
  "outbound.colPending": { da: "Afventer", en: "Pending", es: "Pendientes", fr: "En attente", pt: "Pendentes", de: "Ausstehend" },
  "outbound.colSuccessful": {
    da: "Gennemført",
    en: "Successful",
    es: "Exitosos",
    fr: "Réussis",
  ...
  "outbound.colFailed": { da: "Fejlet", en: "Failed", es: "Fallidos", fr: "Échoués", pt: "Falharam", de: "Fehlgeschlagen" },
  "outbound.colMinutes": { da: "Minutter", en: "Minutes", es: "Minutos", fr: "Minutes", pt: "Minutos", de: "Minuten" },
  "outbound.colLastCall": {
    da: "Seneste opkald",
    en: "Last call",
    es: "Última llamada",
    fr: "Dernier appel",
  ...
  "outbound.colName": { da: "Navn", en: "Name", es: "Nombre", fr: "Nom", pt: "Nome", de: "Name" },
  "outbound.colCompany": { da: "Virksomhed", en: "Company", es: "Empresa", fr: "Entreprise", pt: "Empresa", de: "Unternehmen" },
  "outbound.colPhone": { da: "Telefonnummer", en: "Phone number", es: "Teléfono", fr: "Numéro", pt: "Telefone", de: "Telefonnummer" },
  "outbound.colCallTime": {
    da: "Tidspunkt for opkald",
    en: "Call time",
  ...
  "outbound.colResult": { da: "Opkaldsresultat", en: "Call result", es: "Resultado", fr: "Résultat", pt: "Resultado", de: "Ergebnis" },
  "outbound.contactStatus.pending": {
    da: "Afventer",
    en: "Pending",
    es: "Pendiente",
    fr: "En attente",
  ...
  "outbound.contactStatus.calling": {
    da: "Ringer nu",
    en: "Calling now",
    es: "Llamando",
    fr: "Appel en cours",
  ...
  "outbound.contactStatus.completed": {
    da: "Gennemført",
    en: "Completed",
    es: "Completada",
    fr: "Terminé",
  ...
  "outbound.contactStatus.failed": { da: "Fejlet", en: "Failed", es: "Fallida", fr: "Échoué", pt: "Falhou", de: "Fehlgeschlagen" },
  "outbound.pauseCampaign": {
    da: "Sæt kampagne på pause",
    en: "Pause campaign",
    es: "Pausar campaña",
    fr: "Mettre en pause",
    pt: "Pausar campanha",
    de: "Kampagne pausieren",
  },
  "outbound.resumeCampaign": {
    da: "Genoptag kampagne",
    en: "Resume campaign",
    es: "Reanudar campaña",
    fr: "Reprendre la campagne",
    pt: "Retomar campanha",
    de: "Kampagne fortsetzen",
  },
  "outbound.viewCampaign": {
    da: "Se kontakter",
    en: "View contacts",
    es: "Ver contactos",
    fr: "Voir les contacts",
    pt: "Ver contatos",
    de: "Kontakte ansehen",
  },
  "outbound.backToCampaigns": {
    da: "← Tilbage til kampagner",
    en: "← Back to campaigns",
    es: "← Volver a las campañas",
    fr: "← Retour aux campagnes",
    pt: "← Voltar às campanhas",
    de: "← Zurück zu den Kampagnen",
  },
  "outbound.pausedNotice": {
    da: "Kampagnen er sat på pause. Der startes ingen nye opkald, og et opkald, der allerede er i gang, bliver ikke afbrudt.",
    en: "The campaign is paused. No new calls are started, and a call already in progress is not cut off.",
    es: "La campaña está en pausa. No se inician nuevas llamadas y una llamada en curso no se corta.",
    fr: "La campagne est en pause. Aucun nouvel appel n'est lancé et un appel en cours n'est pas coupé.",
    pt: "A campanha está em pausa. Nenhuma chamada nova é iniciada e uma chamada em curso não é interrompida.",
    de: "Die Kampagne ist pausiert. Es werden keine neuen Anrufe gestartet, und ein laufender Anruf wird nicht abgebrochen.",
  },
  "outbound.resumedNotice": {
    da: "Kampagnen kører igen og fortsætter fra den næste kontakt i køen.",
    en: "The campaign is running again and continues from the next contact in the queue.",
    es: "La campaña está activa de nuevo y continúa desde el siguiente contacto de la cola.",
    fr: "La campagne est de nouveau active et reprend au contact suivant dans la file.",
    pt: "A campanha está ativa novamente e continua a partir do próximo contato na fila.",
    de: "Die Kampagne läuft wieder und macht beim nächsten Kontakt in der Warteschlange weiter.",
  },
  "outbound.errorStatusChange": {
    da: "Kampagnens status kunne ikke ændres.",
    en: "Could not change the campaign's status.",
    es: "No se pudo cambiar el estado de la campaña.",
    fr: "Impossible de changer le statut de la campagne.",
    pt: "Não foi possível alterar o estado da campanha.",
    de: "Der Status der Kampagne konnte nicht geändert werden.",
  },
  "outbound.errorLoadContacts": {
    da: "Kunne ikke hente kampagnens kontakter.",
    en: "Could not load the campaign's contacts.",
    es: "No se pudieron cargar los contactos de la campaña.",
    fr: "Impossible de charger les contacts de la campagne.",
    pt: "Não foi possível carregar os contatos da campanha.",
    de: "Die Kontakte der Kampagne konnten nicht geladen werden.",
  },
  "outbound.keptCalledContacts": {
    da: "{count} kontakter blev beholdt, fordi de allerede er ringet op. Deres opkald og resultater slettes ikke.",
    en: "{count} contacts were kept because they have already been called. Their calls and results are not deleted.",
    es: "Se conservaron {count} contactos porque ya fueron llamados. Sus llamadas y resultados no se eliminan.",
    fr: "{count} contacts ont été conservés car ils ont déjà été appelés. Leurs appels et résultats ne sont pas supprimés.",
    pt: "{count} contatos foram mantidos porque já foram chamados. As suas chamadas e resultados não são eliminados.",
    de: "{count} Kontakte wurden behalten, weil sie bereits angerufen wurden. Ihre Anrufe und Ergebnisse werden nicht gelöscht.",
  },
  "outbound.contactsHelp": {
    da: "Én pr. linje: nummer, navn, virksomhed. Navn og virksomhed er valgfrie.",
    en: "One per line: number, name, company. Name and company are optional.",
    es: "Uno por línea: número, nombre, empresa. El nombre y la empresa son opcionales.",
    fr: "Un par ligne : numéro, nom, entreprise. Le nom et l'entreprise sont facultatifs.",
    pt: "Um por linha: número, nome, empresa. O nome e a empresa são opcionais.",
    de: "Einer pro Zeile: Nummer, Name, Unternehmen. Name und Unternehmen sind optional.",
  },
  "outbound.editRunningHint": {
    da: "Kampagnen er i gang. Kontakter, der allerede er ringet op, bliver stående med deres opkald og resultater — nye numre lægges bagest i køen.",
    en: "The campaign is under way. Contacts already called stay as they are, with their calls and results — new numbers join the back of the queue.",
    es: "La campaña está en marcha. Los contactos ya llamados se mantienen con sus llamadas y resultados; los números nuevos van al final de la cola.",
    fr: "La campagne est en cours. Les contacts déjà appelés restent avec leurs appels et résultats ; les nouveaux numéros passent en fin de file.",
    pt: "A campanha está a decorrer. Os contatos já chamados permanecem com as suas chamadas e resultados; os números novos vão para o fim da fila.",
    de: "Die Kampagne läuft. Bereits angerufene Kontakte bleiben mit ihren Anrufen und Ergebnissen bestehen; neue Nummern kommen ans Ende der Warteschlange.",
  },
  "outbound.agentNumberLockedHint": {
    da: "Agent og telefonnummer kan kun ændres, når kampagnen er på pause.",
    en: "The agent and phone number can only be changed while the campaign is paused.",
    es: "El agente y el número solo se pueden cambiar con la campaña en pausa.",
    fr: "L'agent et le numéro ne peuvent être modifiés que lorsque la campagne est en pause.",
    pt: "O agente e o número só podem ser alterados com a campanha em pausa.",
    de: "Agent und Telefonnummer lassen sich nur ändern, solange die Kampagne pausiert ist.",
  },
  "outbound.noContactsYet": {
    da: "Der er ingen kontakter på denne kampagne.",
    en: "This campaign has no contacts.",
    es: "Esta campaña no tiene contactos.",
    fr: "Cette campagne n'a aucun contact.",
    pt: "Esta campanha não tem contatos.",
    de: "Diese Kampagne hat keine Kontakte.",
  },
  "outbound.notCalledYet": {
    da: "Ikke ringet op endnu",
    en: "Not called yet",
    es: "Aún sin llamar",
    fr: "Pas encore appelé",
    pt: "Ainda não chamado",
    de: "Noch nicht angerufen",
  },
  "outbound.callDetails": {
    da: "Se opkald",
    en: "View call",
    es: "Ver llamada",
    fr: "Voir l'appel",
  ...
  // The call itself, shown above the tabs for an outbound campaign call. An
  // inbound conversation carries its own timestamps on the conversation row
  // and does not send these.
  "session-details-modal.callTime": {
    da: "Opkaldstidspunkt",
    en: "Call time",
    es: "Hora de la llamada",
    fr: "Heure de l'appel",
  ...
  "session-details-modal.callDuration": {
    da: "Varighed",
    en: "Duration",
    es: "Duración",
    fr: "Durée",
  ...
  "session-details-modal.callStatus": { da: "Status", en: "Status", es: "Estado", fr: "Statut", pt: "Estado", de: "Status" },
  "session-details-modal.callResult": {
    da: "Resultat",
    en: "Result",
    es: "Resultado",
    fr: "Résultat",
  ...
  "session-details-modal.callFailureReason": {
    da: "Årsag",
    en: "Reason",
    es: "Motivo",
    fr: "Motif",
  ...
  "session-details-modal.callId": {
    da: "Opkalds-ID hos Vapi",
    en: "Vapi call ID",
    es: "ID de llamada en Vapi",
    fr: "ID d'appel Vapi",
    pt: "ID da chamada na Vapi",
    de: "Vapi-Anruf-ID",
  },
