...
export const dashboardPages: Namespace = {
  ...
  // ---------------------------------------------------------------------
  "dialer.title": { da: "Dialer", en: "Dialer", es: "Marcador", fr: "Numéroteur", pt: "Discador", de: "Dialer" },
  "dialer.subtitleNoNumbers": {
    da: "Ring selv ud til en leadliste, direkte fra browseren.",
    en: "Call a lead list yourself, straight from the browser.",
    es: "Llame usted mismo a una lista de contactos, directamente desde el navegador.",
    fr: "Appelez vous-même une liste de prospects, directement depuis le navigateur.",
    pt: "Ligue você mesmo para uma lista de contactos, diretamente do navegador.",
    de: "Rufen Sie selbst eine Leadliste an — direkt aus dem Browser.",
  },
  "dialer.subtitle": {
    da: "Upload en leadliste og ring selv ud til den, ét opkald ad gangen, direkte fra browseren.",
    en: "Upload a lead list and call through it yourself, one call at a time, straight from the browser.",
    es: "Suba una lista de contactos y llámelos usted mismo, una llamada a la vez, directamente desde el navegador.",
    fr: "Importez une liste de prospects et appelez-les vous-même, un par un, directement depuis le navigateur.",
    pt: "Carregue uma lista de contactos e ligue para eles, uma chamada de cada vez, diretamente do navegador.",
    de: "Laden Sie eine Leadliste hoch und rufen Sie sie selbst durch — einen Anruf nach dem anderen, direkt aus dem Browser.",
  },
  "dialer.noPhoneNumbers": {
    da: 'Køb et telefonnummer under "{inbound}" først — dialer-opkald skal ringes fra et af jeres egne numre.',
    en: 'Get a phone number under "{inbound}" first — dialer calls have to go out from one of your own numbers.',
    es: 'Consiga primero un número de teléfono en "{inbound}" — las llamadas del marcador deben salir desde uno de sus propios números.',
    fr: 'Obtenez d\'abord un numéro de téléphone sous "{inbound}" — les appels du numéroteur doivent partir de l\'un de vos propres numéros.',
    pt: 'Obtenha primeiro um número de telefone em "{inbound}" — as chamadas do discador têm de partir de um dos seus próprios números.',
    de: 'Holen Sie sich zuerst eine Telefonnummer unter "{inbound}" — Dialer-Anrufe müssen von einer Ihrer eigenen Nummern ausgehen.',
  },
  "dialer.newList": {
    da: "+ Ny leadliste",
    en: "+ New lead list",
    es: "+ Nueva lista de contactos",
    fr: "+ Nouvelle liste de prospects",
    pt: "+ Nova lista de contactos",
    de: "+ Neue Leadliste",
  },
  "dialer.listNameLabel": {
    da: "Listenavn",
    en: "List name",
  ...
  "dialer.listNamePlaceholder": {
    da: "Fx Kolde leads – uge 34",
    en: "E.g. Cold leads – week 34",
    es: "Ej.: Contactos fríos – semana 34",
    fr: "Ex. : Prospects froids – semaine 34",
    pt: "Ex.: Contactos frios – semana 34",
    de: "Z. B. Kalte Leads – Woche 34",
  },
  "dialer.leadsLabel": {
    da: "Leads (ét pr. linje, maks. 500)",
    en: "Leads (one per line, max 500)",
    es: "Contactos (uno por línea, máx. 500)",
    fr: "Prospects (un par ligne, max. 500)",
    pt: "Contactos (um por linha, máx. 500)",
    de: "Leads (einer pro Zeile, max. 500)",
  },
  "dialer.uploadFileLabel": {
    da: "Upload CSV/TXT-fil",
    en: "Upload CSV/TXT file",
    es: "Subir archivo CSV/TXT",
    fr: "Importer un fichier CSV/TXT",
    pt: "Carregar ficheiro CSV/TXT",
    de: "CSV/TXT-Datei hochladen",
  },
  "dialer.creating": {
    da: "Opretter…",
    en: "Creating…",
  ...
  "dialer.yourLists": {
    da: "Jeres leadlister",
    en: "Your lead lists",
    es: "Sus listas de contactos",
    fr: "Vos listes de prospects",
    pt: "As suas listas de contactos",
    de: "Ihre Leadlisten",
  },
  "dialer.noListsYet": {
    da: "Ingen leadlister endnu.",
    en: "No lead lists yet.",
    es: "Aún no hay listas de contactos.",
    fr: "Aucune liste de prospects pour l'instant.",
    pt: "Ainda não há listas de contactos.",
    de: "Noch keine Leadlisten.",
  },
  "dialer.leadsCount": {
    da: "{count} leads",
    en: "{count} leads",
  ...
  "dialer.selectListPrompt": {
    da: "Vælg en leadliste for at starte dialer-opkald.",
    en: "Select a lead list to start making dialer calls.",
    es: "Seleccione una lista de contactos para empezar a llamar.",
    fr: "Sélectionnez une liste de prospects pour commencer à appeler.",
    pt: "Selecione uma lista de contactos para começar a ligar.",
    de: "Wählen Sie eine Leadliste, um mit den Dialer-Anrufen zu beginnen.",
  },
  "dialer.calledProgress": {
    da: "{called} af {total} ringet",
    en: "{called} of {total} called",
    es: "{called} de {total} llamados",
    fr: "{called} sur {total} appelés",
    pt: "{called} de {total} contactados",
    de: "{called} von {total} angerufen",
  },
  "dialer.callFromLabel": {
    da: "Ring fra",
    en: "Call from",
    es: "Llamar desde",
    fr: "Appeler depuis",
    pt: "Ligar a partir de",
    de: "Anrufen von",
  },
  "dialer.callFromOption": {
    da: "Ring fra: {label}",
    en: "Call from: {label}",
    es: "Llamar desde: {label}",
    fr: "Appeler depuis : {label}",
    pt: "Ligar a partir de: {label}",
    de: "Anrufen von: {label}",
  },
  "dialer.allCalled": {
    da: "Alle leads på listen er ringet igennem.",
    en: "Every lead on this list has been called.",
    es: "Se ha llamado a todos los contactos de esta lista.",
    fr: "Tous les prospects de cette liste ont été appelés.",
    pt: "Todos os contactos desta lista já foram contactados.",
    de: "Alle Leads auf dieser Liste wurden angerufen.",
  },
  "dialer.unknownName": {
    da: "Ukendt navn",
    en: "Unknown name",
  ...
  "dialer.alreadyCalled": {
    da: "Allerede ringet",
    en: "Already called",
    es: "Ya llamado",
    fr: "Déjà appelé",
    pt: "Já contactado",
    de: "Bereits angerufen",
  },
  "dialer.callButton": {
    da: "Ring op",
    en: "Call",
  ...
  "dialer.inCall": {
    da: "I samtale — {seconds}",
    en: "On call — {seconds}",
    es: "En llamada — {seconds}",
    fr: "En appel — {seconds}",
    pt: "Em chamada — {seconds}",
    de: "Im Gespräch — {seconds}",
  },
  "dialer.mute": {
    da: "Mute",
    en: "Mute",
  ...
  "dialer.wrapupPrompt": {
    da: "Opkald afsluttet — hvad var udfaldet?",
    en: "Call ended — what was the outcome?",
    es: "Llamada finalizada — ¿cuál fue el resultado?",
    fr: "Appel terminé — quel a été le résultat ?",
    pt: "Chamada terminada — qual foi o resultado?",
    de: "Anruf beendet — wie war das Ergebnis?",
  },
  "dialer.selectOutcome": {
    da: "Vælg udfald…",
    en: "Select an outcome…",
    es: "Seleccione un resultado…",
    fr: "Sélectionnez un résultat…",
    pt: "Selecione um resultado…",
    de: "Ergebnis auswählen …",
  },
  "dialer.notesPlaceholder": {
    da: "Noter (valgfrit)",
    en: "Notes (optional)",
    es: "Notas (opcional)",
    fr: "Notes (facultatif)",
  ...
  "dialer.saveAndNext": {
    da: "Gem og ring til næste →",
    en: "Save and call next →",
    es: "Guardar y llamar al siguiente →",
    fr: "Enregistrer et appeler le suivant →",
    pt: "Guardar e ligar ao próximo →",
    de: "Speichern und nächsten anrufen →",
  },
  "dialer.errorNameRequired": {
    da: "Angiv et navn til listen.",
    en: "Give the list a name.",
    es: "Ponga un nombre a la lista.",
    fr: "Donnez un nom à la liste.",
    pt: "Dê um nome à lista.",
    de: "Geben Sie der Liste einen Namen.",
  },
  "dialer.errorNoLeads": {
    da: "Indsæt mindst ét telefonnummer.",
    en: "Paste in at least one phone number.",
    es: "Introduzca al menos un número de teléfono.",
    fr: "Saisissez au moins un numéro de téléphone.",
    pt: "Introduza pelo menos um número de telefone.",
    de: "Geben Sie mindestens eine Telefonnummer ein.",
  },
  "dialer.errorTooManyLeads": {
    da: "Maks. 500 leads pr. liste.",
    en: "Max 500 leads per list.",
    es: "Máx. 500 contactos por lista.",
    fr: "Max. 500 prospects par liste.",
    pt: "Máx. 500 contactos por lista.",
    de: "Max. 500 Leads pro Liste.",
  },
  "dialer.errorCreateListFailed": {
    da: "Kunne ikke oprette listen.",
    en: "Couldn't create the list.",
    es: "No se pudo crear la lista.",
    fr: "Impossible de créer la liste.",
    pt: "Não foi possível criar a lista.",
    de: "Die Liste konnte nicht erstellt werden.",
  },
  "dialer.errorTokenFailed": {
    da: "Kunne ikke hente adgangstoken til opkald.",
    en: "Couldn't get a call access token.",
    es: "No se pudo obtener el token de acceso para llamadas.",
    fr: "Impossible d'obtenir le jeton d'accès pour les appels.",
    pt: "Não foi possível obter o token de acesso para chamadas.",
    de: "Zugriffstoken für Anrufe konnte nicht abgerufen werden.",
  },
  "dialer.errorConnectionFailed": {
    da: "Der opstod en fejl med telefonforbindelsen.",
    en: "Something went wrong with the phone connection.",
    es: "Se produjo un error con la conexión telefónica.",
    fr: "Une erreur est survenue avec la connexion téléphonique.",
    pt: "Ocorreu um erro com a ligação telefónica.",
    de: "Bei der Telefonverbindung ist ein Fehler aufgetreten.",
  },
  "dialer.errorDuringCall": {
    da: "Der opstod en fejl under opkaldet.",
    en: "Something went wrong during the call.",
    es: "Se produjo un error durante la llamada.",
    fr: "Une erreur est survenue pendant l'appel.",
    pt: "Ocorreu um erro durante a chamada.",
    de: "Während des Anrufs ist ein Fehler aufgetreten.",
  },
  "dialer.errorStartCallFailed": {
    da: "Kunne ikke starte opkaldet.",
    en: "Couldn't start the call.",
    es: "No se pudo iniciar la llamada.",
    fr: "Impossible de démarrer l'appel.",
    pt: "Não foi possível iniciar a chamada.",
    de: "Der Anruf konnte nicht gestartet werden.",
  },
  "dialer.errorSdkLoadFailed": {
    da: "Kunne ikke indlæse Twilio Voice SDK.",
    en: "Couldn't load the Twilio Voice SDK.",
    es: "No se pudo cargar el SDK de Twilio Voice.",
    fr: "Impossible de charger le SDK Twilio Voice.",
    pt: "Não foi possível carregar o SDK do Twilio Voice.",
    de: "Das Twilio Voice SDK konnte nicht geladen werden.",
  },
  "dialer.errorSdkMissingDevice": {
    da: "Twilio Voice SDK blev indlæst, men mangler en vigtig komponent.",
    en: "The Twilio Voice SDK loaded, but a required component is missing.",
    es: "El SDK de Twilio Voice se cargó, pero falta un componente necesario.",
    fr: "Le SDK Twilio Voice s'est chargé, mais un composant requis est manquant.",
    pt: "O SDK do Twilio Voice foi carregado, mas falta um componente necessário.",
    de: "Das Twilio Voice SDK wurde geladen, aber eine erforderliche Komponente fehlt.",
  },
  "dialer.disposition.booked": {
    da: "Booket møde",
    en: "Booked a meeting",
    es: "Reunión reservada",
    fr: "Rendez-vous pris",
    pt: "Reunião marcada",
    de: "Termin gebucht",
  },
  "dialer.disposition.interested": {
    da: "Interesseret — følg op",
    en: "Interested — follow up",
    es: "Interesado — seguimiento",
    fr: "Intéressé — à relancer",
    pt: "Interessado — dar seguimento",
    de: "Interessiert — nachfassen",
  },
  "dialer.disposition.notInterested": {
    da: "Ikke interesseret",
    en: "Not interested",
    es: "No interesado",
    fr: "Pas intéressé",
    pt: "Não interessado",
  ...
  "dialer.disposition.callBack": {
    da: "Ring igen senere",
    en: "Call back later",
    es: "Volver a llamar más tarde",
    fr: "Rappeler plus tard",
    pt: "Voltar a ligar mais tarde",
    de: "Später zurückrufen",
  },
  "dialer.disposition.noAnswer": {
    da: "Ingen svar",
    en: "No answer",
    es: "Sin respuesta",
    fr: "Pas de réponse",
  ...
  "dialer.disposition.voicemail": {
    da: "Lagde besked",
    en: "Left voicemail",
    es: "Dejó mensaje de voz",
    fr: "Message vocal laissé",
    pt: "Deixou mensagem de voz",
    de: "Mailbox besprochen",
  },
  "dialer.disposition.wrongNumber": {
    da: "Forkert nummer",
    en: "Wrong number",
  ...
  // ---------------------------------------------------------------------
  // components/dashboard/twilio-balance-card.tsx
  // ---------------------------------------------------------------------
  "twilioBalance.errorFetch": {
    da: "Kunne ikke hente Twilio-forbrug.",
    en: "Couldn't fetch Twilio usage.",
    es: "No se pudo obtener el uso de Twilio.",
    fr: "Impossible de récupérer l'utilisation Twilio.",
    pt: "Não foi possível obter o uso do Twilio.",
    de: "Twilio-Nutzung konnte nicht abgerufen werden.",
  },
  "twilioBalance.loading": {
    da: "Henter Twilio-forbrug…",
    en: "Fetching Twilio usage…",
    es: "Obteniendo uso de Twilio…",
    fr: "Récupération de l'utilisation Twilio…",
    pt: "A obter o uso do Twilio…",
    de: "Twilio-Nutzung wird abgerufen …",
  },
  "twilioBalance.show": {
    da: "Vis Twilio-forbrug →",
    en: "Show Twilio usage →",
    es: "Mostrar uso de Twilio →",
    fr: "Afficher l'utilisation Twilio →",
    pt: "Mostrar uso do Twilio →",
    de: "Twilio-Nutzung anzeigen →",
  },
  "twilioBalance.retry": {
    da: "Prøv igen",
    en: "Try again",
  ...
  "twilioBalance.balance": {
    da: "Twilio-saldo: {balance} {currency}",
    en: "Twilio balance: {balance} {currency}",
    es: "Saldo de Twilio: {balance} {currency}",
    fr: "Solde Twilio : {balance} {currency}",
    pt: "Saldo Twilio: {balance} {currency}",
    de: "Twilio-Guthaben: {balance} {currency}",
  },
  "twilioBalance.updating": {
    da: "Opdaterer…",
    en: "Updating…",
    es: "Actualizando…",
    fr: "Mise à jour…",
  ...
  "twilioBalance.minutesUsed": {
    da: "{minutes} min brugt",
    en: "{minutes} min used",
    es: "{minutes} min usados",
    fr: "{minutes} min utilisées",
    pt: "{minutes} min usados",
    de: "{minutes} Min. verbraucht",
  },
  "twilioBalance.minutesRemaining": {
    da: "ca. {minutes} min tilbage",
    en: "approx. {minutes} min left",
    es: "aprox. {minutes} min restantes",
    fr: "environ {minutes} min restantes",
    pt: "aprox. {minutes} min restantes",
    de: "ca. {minutes} Min. übrig",
  },
